...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "1202 Request helps startup shareholders organize stock facts, request issuer evidence, and export a CPA-ready dossier for Section 1202 review." },
      { property: "og:title", content: "1202 Request — Issuer evidence for Section 1202 review" },
      { property: "og:description", content: "Request the issuer evidence your CPA needs for Section 1202 review." },
