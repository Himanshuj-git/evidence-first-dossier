      ...
      <div className="qsbs-card max-w-md w-full p-6 shadow-xl" onClick={(e) => e.stopPropagation()}>
        ...
        <p className="mt-4 text-sm text-muted-foreground leading-relaxed">
          {p.href
            ...
            : <>Secure checkout coming soon. To go live, paste your Stripe Payment Link in <Link to="/settings" className="qsbs-link">Settings</Link>. For now you can simulate a successful checkout and unlock features locally.</>}
        </p>
        {p.href ? (
